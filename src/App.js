...
function App() {
	...
	return (
		<>
			...
			<div className="bg-gradient-to-tr from-pink-500 to-blue-500 pt-3">
				...
				<div className="flex justify-end items-center py-4 mr-4">
					<button
						...
						disabled={pageNo === 1}
						className={`  px-4  py-2 rounded bg-gradient-to-tr bg-theme-yellow to-theme-yellow from-theme-pink ${pageNo === 1 ? "opacity-50 cursor-not-allowed" : ""
							}`}
					>
						Previous
					</button>
					...
					<button
						className={`rounded px-4 py-2 bg-gradient-to-tr bg-theme-yellow to-theme-yellow from-theme-pink ${!hasNext ? "opacity-50 cursor-not-allowed " : "hover:bg-blue-600"
							}`}
